...
|   Model   | pre_seq_len | post_seq_len | max_source_length | max_target_length | rouge1 | rouge2 | rougeL | batch_size |  |  |
| :-------: | :---------: | :----------: | :---------------: | :---------------: | :----: | :----: | :----: | :--------: | :-: | :-: |
| Bart-base |      0      |      0      |        512        |        300        | 49.35 | 19.38 | 48.05 |   2 * 3   |  |  |
|    RMT    |     20     |      0      |        512        |        300        | 48.94 | 18.76 | 47.66 |   2 * 3   |  |  |
|    RMT    |     32     |      0      |        512        |        300        | 49.44 | 19.16 | 48.14 |   2 * 3   |  |  |
|    RMT    |     64     |      0      |        512        |        300        | 49.14 | 18.79 | 47.85 |   2 * 3   |  |  |
|    RMT    |     100     |      0      |        512        |        300        | 49.83 | 19.66 | 48.52 |   2 * 3   |  |  |
|    RMT    |     128     |      0      |        512        |        300        | 50.04 | 19.75 | 48.72 |   2 * 3   |  |  |
|    RMT    |     150     |      0      |        512        |        300        | 50.15 | 19.91 | 48.85 |   2 * 3   |  |  |
|    RMT    |     200     |      0      |        512        |        300        | 50.59 | 20.24 | 49.31 |   2 * 3   |  |  |
|    RMT    |     212     |      0      |        512        |        300        | 50.25 | 20.03 | 48.95 |   2 * 3   |  |  |
|    RMT    |     256     |      0      |        512        |        300        | 50.25 | 20.03 | 48.92 |   2 * 3   |  |  |
|    RMT    |      0      |     300     |        512        |        300        | 41.86 | 14.25 | 40.72 |   2 * 3   |  |  |
|    RMT    |     20     |     300     |        512        |        300        |        |        | :---: |   2 * 3   |  |  |
|    RMT    |     32     |     300     |        512        |        300        |        |        | :---: |   2 * 3   |  |  |
|    RMT    |     64     |     300     |        512        |        300        |        |        | :---: |   2 * 3   |  |  |
|    RMT    |     100     |     300     |        512        |        300        |        |        | :---: |   2 * 3   |  |  |
|    RMT    |     128     |     300     |        512        |        300        |        |        | :---: |   2 * 3   |  |  |
|    RMT    |     150     |     300     |        512        |        300        |        |        | :---: |   2 * 3   |  |  |
|    RMT    |     200     |     300     |        512        |        300        |        |        | :---: |   2 * 3   |  |  |
|    RMT    |     212     |     300     |        512        |        300        | 45.73 | 17.81 | 44.51 |   2 * 3   |  |  |
