...
|   Model   | pre_seq_len | post_seq_len | max_source_length | max_target_length | rouge1 | rouge2 | rougeL | batch_size | lr   |
| :-------: | :---------: | :----------: | :---------------: | :---------------: | :----: | :----: | :----: | :--------: | ---- |
| Bart-base |      0      |      0      |        512        |        300        | 50.49 | 18.51 | 25.01 |   1 * 3   | 3e-6 |
|          |     10     |              |                  |                  | 48.10 | 19.15 | 23.29 |            | 3e-6 |
|    RMT    |     20     |      0      |        512        |        300        |        |        |        |   1 * 3   | 3e-6 |
|    RMT    |     32     |      0      |        512        |        300        | 49.20 | 18.00 | 24.64 |   1 * 3   | 3e-6 |
|    RMT    |     64     |      0      |        512        |        300        | 50.08 | 18.11 | 24.68 |   1 * 3   | 3e-6 |
|          |     64     |              |                  |                  | 49.39 |        |        |   2 * 3   | 3e-6 |
|          |     64     |              |                  |                  | 47.77 | 19.00 | 23.29 |   1 * 3   | 3e-7 |
|          |     64     |              |                  |                  | 47.47 | 18.40 | 23.21 |   4 * 3   | 5e-7 |
|    RMT    |     100     |      0      |        512        |        300        | 48.21 | 17.35 | 24.47 |   1 * 3   | 3e-6 |
|          |     100     |              |                  |                  | 47.81 |        |        |            | 5e-7 |
|    RMT    |     128     |      0      |        512        |        300        | 49.17 | 17.41 | 24.45 |   1 * 3   | 3e-6 |
|          |     128     |              |                  |                  | 47.44 | 18.95 | 23.36 |   1 * 3   | 5e-7 |
|    RMT    |     150     |      0      |        512        |        300        | 49.51 | 18.02 | 25.02 |   1 * 3   | 3e-6 |
|    RMT    |     200     |      0      |        512        |        300        | 46.63 | 18.62 | 23.35 |   1 * 3   | 3e-6 |
|    RMT    |     212     |      0      |        512        |       3004       | 47.24 | 16.85 | 24.55 |   1 * 3   | 3e-6 |
|    RMT    |     256     |      0      |        512        |        300        | 44.94 | 17.56 | 22.83 |   1 * 3   | 3e-6 |
|    RMT    |      0      |     300     |        512        |        300        | 33.47 |  8.92  | 18.38 |   1 * 3   | 3e-6 |
|    RMT    |     20     |     300     |        512        |        300        | 41.24 | 13.37 | 21.95 |   1 * 3   | 3e-6 |
|    RMT    |     32     |     300     |        512        |        300        |        |        |        |   1 * 3   | 3e-6 |
|    RMT    |     64     |     300     |        512        |        300        | 41.21 | 13.92 | 22.25 |   1 * 3   | 3e-6 |
|          |     64     |              |                  |                  | 40.16 | 13.53 | 22.54 |            | 3e-5 |
|          |     64     |              |                  |                  |        |        |        |            | 5e-7 |
|    RMT    |     100     |     300     |        512        |        300        |        |        |        |   1 * 3   | 3e-6 |
|    RMT    |     128     |     300     |        512        |        300        |        |        |        |   1 * 3   | 3e-6 |
|    RMT    |     150     |     300     |        512        |        300        |        |        |        |   1 * 3   | 3e-6 |
|    RMT    |     200     |     300     |        512        |        300        |        |        |        |   1 * 3   | 3e-6 |
|    RMT    |     212     |     300     |        512        |        300        | 45.73 | 17.81 | 44.51 |   2 * 3   | 5e-5 |
