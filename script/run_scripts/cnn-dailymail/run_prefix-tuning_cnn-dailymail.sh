...
export TRAINING_STRATEGY=BaseModelWithPrefixTuning
...
# export DISPLAY_NAME=BaseModelWithPrefixTuning-CnnDailymail
# export RUN_ID=1
# export WANDB_MODE=online
# export LINEAGE=BaseModelWithPrefixTuning-CnnDailymail # This is just a tag on wandb to make tracking runs easier
# export WANDB_PROJECT_NAME="kaifan-li/BaseModelWithPrefixTuning-CnnDailymail" # IMPORTANT: set this to your own wandb project
